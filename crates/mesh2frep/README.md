...
Of note, the SDF generated by this program behaves nicely at sharp edges - subtracting a constant value, `c`, from the field should result in the equivalent of adding the
